...
public class HowManyWords {
	...
	public static void main(String[] args) {
		...
		String str =" Paragraphs are the building blocks of papers."
				+ "Many students define paragraphs in terms of length: a paragraph is a group of"
				+ "at least five sentences, a paragraph is half a page long, etc. In reality, though,"
				...
				+ "a unit” (Lunsford and Connors 116). Length and appearance do not determine whether"
				...
				+ "one main idea. In this handout, we will refer to this as the “controlling idea,”" 
